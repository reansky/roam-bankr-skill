...
- `references/upi.md`
- `references/nets.md`
- `references/promptpay.md`
- `references/jpqr.md`
- `references/evm.md`
- `references/crypto-qr.md`
- `references/currency-intelligence.md`
...
- "How much USDC is Rp15,000?" -> normalize IDR and return a live quote only.
- "Pay this QR Rp15,000 using USDC on Base." -> run the full workflow, but stop if no verified settlement route exists.
- "Pay ₹500 with ETH on Base." -> normalize INR, quote ETH, verify route, summarize, and ask for confirmation before execution.
- "Pay 10 USDC to this EVM QR on Base." -> validate the direct crypto payment; do not treat it as QRIS, UPI, or another local rail.
